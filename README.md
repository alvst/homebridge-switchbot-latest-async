...
You probably don't need this package and should just use the original package but in very specific circumstances where you need your bot function to be asyncronous, use this. I plan to, at some point, file a pull request to the original package and hope it gets implemented.
